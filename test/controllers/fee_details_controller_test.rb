...
class FeeDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fee_detail" do
    assert_difference('FeeDetail.count') do
      post fee_details_url, params: { fee_detail: { month: @fee_detail.month, status: @fee_detail.status, student_id: @fee_detail.student_id, user_id: @fee_detail.user_id } }
    end
  ...
  test "should update fee_detail" do
    patch fee_detail_url(@fee_detail), params: { fee_detail: { month: @fee_detail.month, status: @fee_detail.status, student_id: @fee_detail.student_id, user_id: @fee_detail.user_id } }
